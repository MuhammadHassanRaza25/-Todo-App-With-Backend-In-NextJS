...
export default function Header(){
    return(
    <>
       <h1 className='header flex justify-between items-center p-3.5 py-3 px-7 bg-slate-700 border-b-2 border-cyan-400 text-3xl font-semibold w-full'><span className="text-white">Todo <span className='text-cyan-400'>App</span></span> 
